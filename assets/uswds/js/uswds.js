...
*/
    ...
    17: [
      ...
      { "../../uswds-core/src/js/utils/behavior": 45, "receptor/keymap": 11 },
    ],
    18: [
      function (require, module, exports) {
        "use strict";
        ...
        const updateCountMessage = (inputEl) => {
          ...
          const currentStatusMessage = getCountMessage(
            currentLength,
            maxLength
          );
          if (!maxLength) return;
    ...
    27: [
      function (require, module, exports) {
        ...
        const focusLanguageButton = (event) => {
          const parentLanguageItem = event.target.closest(
            LANGUAGE_PRIMARY_ITEM
          );
      ...
      function (require, module, exports) {
        ...
        module.exports = function getScrollbarWidth() {
          ...
          if (document.body) {
            ...
            console.log("ack something went wrong:");
