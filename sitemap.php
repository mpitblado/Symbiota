...
<body>
	...
	<div id="innertext">
		...
		<div id="sitemap">
			...
			<ul>
				<li>
					<a href="<?php echo $actionPage ?>">
					<!-- <a href="<?php echo $CLIENT_ROOT ?>/collections/search/index.php"> -->
						<?php echo htmlspecialchars($LANG['SEARCHENGINE'], HTML_SPECIAL_CHARS_FLAGS);?>
					</a>
					 - <?php echo htmlspecialchars($LANG['SEARCH_COLL'], HTML_SPECIAL_CHARS_FLAGS);?>
				</li>
