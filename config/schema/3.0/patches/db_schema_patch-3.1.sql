...
ALTER TABLE `taxa` ADD COLUMN `cultivarEpithet` VARCHAR(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' AFTER unitName3;
ALTER TABLE `taxa` ADD COLUMN `tradeName` VARCHAR(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' AFTER cultivarEpithet;
