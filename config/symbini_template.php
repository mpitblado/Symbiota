...
$MAPPING_BOUNDARIES = '';			//Project bounding box. Should be North;East;South;West . Default map centering; (e.g. 42.3;-100.5;18.0;-127)
...
$TAXONOMIC_AUTHORITIES = array('COL' => '', 'WoRMS' => '');		//List of taxonomic authority APIs to use in data cleaning and thesaurus building tools, concatenated with commas and order by preference; E.g.: array('COL'=>'', 'WoRMS'=>'', 'bryonames' => 'The Bryophyte Nomenclator', 'fdex'=>'Index Fungorum via F-Dex', 'TROPICOS'=>'', 'EOL'=>'')
