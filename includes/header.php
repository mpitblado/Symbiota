			...
			<div id="top_navbar">
				...
				<ul id="hor_dropdown">
					...
					<li>
						...
						<ul>
                                                        <li>
                                                                <a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=3" >Amphibians & Reptiles</a>
                                                        </li>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=1" >Mammals</a>
							</li>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=2" >Plants</a>
							</li>
						</ul>
					</li>
					<li>
