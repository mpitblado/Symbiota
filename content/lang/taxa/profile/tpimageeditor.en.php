...
$LANG['NO_IMAGES'] = 'No media available';
$LANG['ADD_NEW_IMAGE'] = 'Add New Media';
$LANG['SELECT_IMAGE_TO_UPLOAD'] = 'Select an media file located on your computer that you want to upload';
...
$LANG['LINK_TO_EXTERNAL'] = 'Link to External Media';
$LANG['ENTER_URL_IMG'] = 'Enter a URL to a media file already located on a web server';
...
$LANG['DISP_PHOTOGRAPHER_OVERRIDE'] = 'Display photographer override field';
$LANG['PHOTOGRAPHER_OVERRIDE'] = 'Photographer Override';
$LANG['PHOTOGRAPHER_OVERRIDE_EXPLAIN'] = 'Use only when photographer is not found in above pulldown';
$LANG['MANAGER'] = 'Manager';
$LANG['URL_TO_SOURCE'] = 'URL to source project. Use when linking to an external media.';
...
$LANG['NOTES'] = 'Notes';
$LANG['UPLOAD_IMAGE'] = 'Upload Media';
