...
------------------
*/
$LANG['VOUCHER_ADMIN'] = 'Administration des bons';
...
$LANG['COUNTRY'] = 'Pays';
$LANG['ENTER_MULT_COUNTRIES'] = 'Entrez plusieurs pays séparés par des points-virgules';
$LANG['STATE'] = 'État';
$LANG['ENTER_MULT_STATES'] = 'Entrez plusieurs états séparés par des points-virgules';
$LANG['COUNTY'] = 'Comté';
$LANG['ENTER_MULT_COUNTIES'] = 'Entrez plusieurs comtés séparés par des points-virgules';
$LANG['LOCALITY'] = 'Localité';
$LANG['TAXON'] = 'Taxon';
$LANG['GEN_FAM_HIGHER'] = 'Genre, famille ou rang supérieur';
$LANG['COLLECTION'] = 'Collection';
$LANG['TARGETCOLL'] = 'Rechercher dans toutes Collections';
$LANG['CHECKVOUCINSTRUC'] = "Pour utiliser les fonctions d'administration des échantillons, il est d'abord nécessaire de définir des termes de recherche qui seront utilisés pour limiter les enregistrements d'occurrences à ceux collectés à proximité de la zone de recherche.";
$LANG['COLLECTOR'] = 'Collectionneur';
$LANG['MULTIPLE_COLLECTORS'] = 'Entrez plusieurs collecteurs séparés par des points-virgules';
$LANG['LATN'] = 'Lat Nord';
$LANG['LAT_NORTH'] = 'Latitude Nord';
$LANG['FIND_COORD'] = 'Trouver les coordonnées';
$LANG['LATS'] = 'Lat Sud';
$LANG['LAT_SOUTH'] = 'Latitude Sud';
$LANG['LONGE'] = 'Long Est';
$LANG['LONG_EAST'] = 'Longitude Est';
$LANG['LONGW'] = 'Long Ouest';
$LANG['LONG_WEST'] = 'Longitude Ouest';
$LANG['EDIT_META_POLYGON'] = 'Modifier les métadonnées et le polygone';
$LANG['SURE_DELETE_QUERY'] = 'Êtes-vous sûr de vouloir supprimer les variables de requête?';
$LANG['ERREUR'] = 'Erreur';
$LANG['ONLYCOORD'] = 'Inclure uniquement les occurrences avec des coordonnées';
$LANG['POLYGON_SEARCH'] = 'Recherche basée sur un polygone définissant les limites de recherche de la liste';
...
$LANG['LINKVOUCHSPECIMEN'] = 'Lier les Échantillons';
$LANG['REFRESHLIST'] = 'Actualiser Liste';
