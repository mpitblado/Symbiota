...
$LANG['DELPROJECT'] = 'Borrar proyecto';
$LANG['CONFIRMDEL'] = '¿Está seguro de que desea eliminar este proyecto de inventario? ¡La acción no se puede deshacer!';
$LANG['SUBMITDELETE'] = 'Borrar proyecto';
$LANG['DELCONDITION1'] = 'El proyecto de inventario no se puede eliminar hasta que todos los dem&aacute;s gerentes se eliminen como gerentes de proyecto';
$LANG['DELCONDITION2'] = 'El proyecto de inventario no se puede eliminar hasta que se eliminen todas las listas de verificaci&oacute;n del proyecto';
