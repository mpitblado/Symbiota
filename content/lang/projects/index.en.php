...
$LANG['DELPROJECT'] = 'Delete Project';
$LANG['CONFIRMDEL'] = 'Are you sure you want to delete this inventory Project? Action cannot be undone!';
$LANG['SUBMITDELETE'] = 'Delete Project';
$LANG['DELCONDITION1'] = 'Inventory project cannot be deleted until all other managers are removed as project managers';
$LANG['DELCONDITION2'] = 'Inventory project cannot be deleted until all checklists are removed from the project';
