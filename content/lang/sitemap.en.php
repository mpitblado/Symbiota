...
$LANG['IMGLIB'] = 'Multimedia Library';
$LANG['IMAGE_SEARCH'] = 'Interactive Search Tool';
$LANG['CONTRIB'] = 'Multimedia Contributors';
...
$LANG['IMGSUB'] = 'Multimedia Submission';
$LANG['FORANOVERVIEW'] = 'for an overview of how multimedia are managed within a Symbiota data portal. Field multimedia without                                                detailed locality information can be uploaded using the Taxon Species Profile page.                                                Specimen multimedia are loaded through the Specimen Editing page or through a batch upload process                                                established by a portal manager. Multimedia Observations (Multimedia Vouchers) with detailed locality information can be                                                uploaded using the link below. Note that you will need the necessary permission assignments to use this                                                feature. ';
$LANG['BASICFIELD'] = 'Basic Field Multimedia Submission';
$LANG['IMGOBSER'] = 'Multimedia Observation Submission Module';
...
$LANG['OIVS'] = 'Observation Multimedia Voucher Submission';
...
$LANG['EDITIMG'] = 'Edit Multimedia';
$LANG['IMGSORTORD'] = 'Edit Multimedia Sorting Order';
$LANG['ADDNEWIMG'] = 'Add a new Multimedia';
