...
$LANG['IMGLIB'] = 'Biblioteca multimedia';
$LANG['IMAGE_SEARCH'] = 'Herramienta de búsqueda interactiva';
$LANG['CONTRIB'] = 'Colaboradores multimedia';
...
$LANG['IMGSUB'] = 'Envío multimedia';
$LANG['FORANOVERVIEW'] = 'para obtener una descripción general de cómo se gestionan los multimedia dentro de un portal de datos Symbiota. Se pueden cargar archivos multimedia de campo sin información detallada de la localidad utilizando la página Perfil de especies taxonómicas.                                                Los archivos multimedia de muestras se cargan a través de la página Edición de muestras o mediante un proceso de carga por lotes establecido por un administrador del portal. Las observaciones multimedia (vales multimedia) con información detallada de la localidad se pueden cargar utilizando el siguiente enlace. Tenga en cuenta que necesitará las asignaciones de permisos necesarias para utilizar esta función. ';
$LANG['BASICFIELD'] = 'Envío multimedia de campo básico';
$LANG['IMGOBSER'] = 'Módulo de envío de observaciones multimedia';
...
$LANG['PARA2'] = 'La gestión de datos para proyectos de observación se maneja de manera similar a lo que se describe en el párrafo anterior sobre Colecciones.                                        Una diferencia es el proyecto de Observación General. Este proyecto tiene dos propósitos centrales: 1) Permite a los usuarios registrados enviar una observación de campo con vale multimedia.                                        2) Permite a los recolectores ingresar los datos de su propia colección para imprimir etiquetas y poner los datos a disposición de las colecciones obteniendo los especímenes físicos mediante donaciones o intercambio. Visita el ';
...
$LANG['OIVS'] = 'Envío de vale multimedia de observación';
...
$LANG['EDITIMG'] = 'Editar multimedia';
$LANG['IMGSORTORD'] = 'Editar orden de clasificación multimedia';
$LANG['ADDNEWIMG'] = 'Agregar un nuevo multimedia';
