...
$LANG['DWCA_PUBLISHER'] = 'Publicador de Archivo Darwin Core';
$LANG['PLS_CHOOSE_COL'] = '¡Por favor elija al menos una colección!';
$LANG['KEY_WRONG'] = 'La llave tiene el número equivocado de dígitos. Deben ser 36 dígitos en total.';
$LANG['KEY_NOT_VALID'] = 'La llave parece no tener un UUID válido (e.g.';
$LANG['KEY_INVALID_CONTACT'] = 'La llave no parece ser válida. Por favor contacte al administrador de su portal para asistencia.';
$LANG['HOME'] = 'Inicio';
$LANG['COL_MANAGEMENT'] = 'Manejo de Colecciones';
$LANG['SITEMAP'] = 'Mapa del Sitio';
$LANG['DISPLAY_CONTROL_PANEL'] = 'Desplegar Panel de Control de Publicación';
...
$LANG['DWCA_DOWNLOAD_EXPLAIN_3'] = 'estándar de cambio. Los archivos de identificación y multimedia siguen las extensiones DwC para esos tipos de datos.';
...
$LANG['TITLE'] = 'Título';
$LANG['SURE_DELETE'] = '¿Está seguro de querer eliminar este archivo?';
$LANG['DELETE_ARCHIVE'] = 'Eliminar Archivo';
$LANG['DESCRIPTION'] = 'Descripción';
$LANG['DWCA_FILE'] = 'Carpeta de Archivo DwC';
$LANG['PUB_DATE'] = 'Fecha de Publicación';
$LANG['DWCA_NOT_PUBLISHED'] = 'Un Archivo Darwin Core aún no ha sido publicado para esta colección';
$LANG['PUB_INFO'] = 'Publicar Información';
$LANG['GUID_SOURCE'] = 'Fuente de GUID';
$LANG['RECORDS_MISSING'] = 'Registros sin';
$LANG['OCCID_GUIDS'] = 'OccurrenceID GUIDs';
$LANG['RECS_TO_NOT_PUBLISH'] = '¡Estos registros no serán publicados!';
$LANG['RECS_WO_CATNUMS'] = 'Registros sin Números de Catálogo';
$LANG['RECS_WILL_NOT_PUBLISH'] = '¡Estos registros no serán publicados!';
$LANG['RECS_MISSING_GUIDS'] = 'Registros sin GUIDs de Symbiota';
$LANG['PLEASE_GO_TO'] = 'Por favor ir al';
$LANG['COLL_GUID_MAP'] = 'Mapeador de GUID para Colecciones';
$LANG['TO_ASSIGN_GUIDS'] = 'para asignar GUIDs de Symbiota';
$LANG['ALREADY_PUBLISHED'] = 'Ya publicado en un portal hermano';
$LANG['GUID_NOT_SET'] = 'La fuente de GUID no ha sido configurada para esta colección. Por favor diríjase a';
$LANG['EDIT_METADATA'] = 'la página Editar Metadatos';
$LANG['TO_SET_GUID'] = 'para establecer una fuente de GUID';
$LANG['CANNOT_PUBLISH'] = 'El archivo no se puede publicar hasta que se establezca la fuente GUID de ID de ocurrencia';
$LANG['THERE_ARE'] = 'Existen';
$LANG['MISSING_BASISOFRECORD'] = 'registros sin basisOfRecord y no serán publicados. Por favor dirigirse a';
...
$LANG['INCLUDE_IMGS'] = 'Incluir URL multimedia';
...
$LANG['MISSING_GUID'] = 'GUID no definido';
$LANG['ALREADY_PUB_DOMAIN'] = 'Ya publicado en un dominio diferente';
