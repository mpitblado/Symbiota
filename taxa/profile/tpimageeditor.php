										...
										if($tnUrl && substr($tnUrl,0,10) != 'processing'){
											...
											<td align='center' valign='bottom'>
												...
												if($imgArr["tid"] != $tid){
													?>
													<div>
														<a href="tpeditor.php?tid=<?php echo htmlspecialchars($imgArr["tid"], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE);?>" target="" title="Linked from"><?php echo htmlspecialchars($imgArr["sciname"], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE);?></a>
													</div>
													<?php
												}
												?>
