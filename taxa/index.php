				...
				<tr>
					<td colspan="2" valign="bottom">
						...
						if($isEditor){
							...
							<div id="editorDiv">
								<?php
								echo '<a href="profile/tpeditor.php?tid=' . htmlspecialchars($taxonManager->getTid(), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '" title="' . htmlspecialchars((isset($LANG['EDIT_TAXON_DATA'])?$LANG['EDIT_TAXON_DATA']:'Edit Taxon Data'), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '">';
						...
						<div id="scinameDiv">
							...
							echo '&nbsp;<a href="' . htmlspecialchars($parentLink, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '"><img class="navIcon" src="../images/toparent.png" style="width:1.3em" title="Go to Parent" /></a>';
				...
				<tr>
					<td width="300" valign="top">
						...
						if(!$taxonManager->echoImages(0,1,0)){
							...
							if($isEditor){
								echo '<a href="profile/tpeditor.php?category=imageadd&tid=' . htmlspecialchars($taxonManager->getTid(), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '"><b>' . htmlspecialchars((isset($LANG['ADD_IMAGE'])?$LANG['ADD_IMAGE']:'Add an Image'), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '</b></a>';
							}
							else{
				...
				<tr>
					<td colspan="2">
						...
						if($imgCnt == 100){
							...
							$tabText .= '<a href="' . htmlspecialchars($CLIENT_ROOT, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '/imagelib/search.php?submitaction=search&taxa=' . htmlspecialchars($tid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '">' . htmlspecialchars((isset($LANG['VIEW_ALL_IMAGES'])?$LANG['VIEW_ALL_IMAGES']:'View All Images'), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '</a>';
						}
						?>
				...
				<tr>
					<td colspan="2" style="vertical-align:top;">
						...
						if($isEditor){
							?>
							<div id="editorDiv">
								<a href="profile/tpeditor.php?tid=<?php echo htmlspecialchars($taxonManager->getTid(), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?>" title="<?php echo htmlspecialchars((isset($LANG['EDIT_TAXON_DATA'])?$LANG['EDIT_TAXON_DATA']:'Edit Taxon Data'), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?>">
						...
						<div id="scinameDiv">
							...
							if($taxonRank > 140){
								...
								$displayName .= '<img class="navIcon" src="../images/toparent.png" style="width:1.3em" title="'.(isset($LANG['GO_TO_PARENT'])?$LANG['GO_TO_PARENT']:'Go to Parent Taxon').'" />';
								$displayName .= '</a>';
							}
							...
							<fieldset style="padding:10px 2px 10px 2px;">
								...
								<?php
									...
									foreach($sppArr as $sciNameKey => $subArr){
										...
										elseif($isEditor){
											echo '<div class="spptext"><a href="profile/tpeditor.php?category=imageadd&tid=' . htmlspecialchars($subArr['tid'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '">' . htmlspecialchars((isset($LANG['ADD_IMAGE'])?$LANG['ADD_IMAGE']:'Add an Image'), ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '!</a></div>';
										}
										else{
