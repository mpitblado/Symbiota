        ...
        if($displayIcons){
            ...
            <div class="<?php ($cArr["icon"]?'cat-icon-div':''); ?>">
                ...
                if($cArr["icon"]){
                    ...
                    ?>
                    <a href = '<?php echo htmlspecialchars($CLIENT_ROOT, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?>/collections/misc/collprofiles.php?collid=<?php echo htmlspecialchars($collid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?>'><img src="<?php echo htmlspecialchars($cIcon, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?>" style="border:0px;width:30px;height:30px;" /></a>
                    <?php
                }
                ?>
                &nbsp;
