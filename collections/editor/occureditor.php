...
<head>
    ...
    if($crowdSourceMode == 1){
		...
		?>
		<link href="../../css/symb/occurrenceeditor.css?ver=6b" type="text/css" rel="stylesheet" id="editorCssLink" />
		<?php
		if(isset($CSSARR)){
									...
									<form id="fullform" name="fullform" action="occurrenceeditor.php" method="post" onsubmit="return verifyFullForm(this);">
										...
										<fieldset>
											...
											<div style="clear:both;">
												...
												<div id="eventDate2Div" title="Latest Date Collected">
													<?php echo (defined('EVENTDATE2LABEL')?EVENTDATE2LABEL:'Latest Date'); ?>
													<a href="#" onclick="return dwcDoc('eventDate2')" tabindex="-1"><img class="docimg" src="../../images/qmark.png" /></a>
													<br/>
													<input type="text" name="eventdate2" value="<?php echo array_key_exists('eventdate2',$occArr)?$occArr['eventdate2']:''; ?>" onchange="eventDateChanged(this);" />
												</div>
												<?php
