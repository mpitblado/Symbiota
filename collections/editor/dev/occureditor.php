...
if($SYMB_UID){
		...
		if($isEditor == 1 || $isEditor == 2){
			...
			elseif($action == 'cloneRecord'){
				...
				if($cloneArr){
					...
					$statusStr .= '<div><a href="occureditor.php?occid=' . $occid . '" target="_blank">#' . $occid . '</a> - ' . $LANG['CLONE_SOURCE'] . '</div>';
					$occid = current($cloneArr);
					$occManager->setOccId($occid);
					foreach($cloneArr as $cloneOccid){
						if($cloneOccid==$occid) $statusStr .= '<div>#'.$cloneOccid.' - '.$LANG['THIS_RECORD'].'</div>';
			...
			elseif($action == "Disassociate Image"){
				if($occManager->remapImage($_POST["imgid"])){
					$statusStr = (isset($LANG['DISASS_SUCCESS'])?$LANG['DISASS_SUCCESS']:'SUCCESS disassociating image').' <a href="'.$CLIENT_ROOT.'/imagelib/imgdetails.php?imgid=' . $_POST["imgid"] . '" target="_blank">#' . $_POST["imgid"] . '</a>';
				}
				else{
	...
	if($qryCnt !== false){
		$navStr = '<b>';
		if($occIndex > 0) $navStr .= '<a href="#" onclick="return submitQueryForm(0);" title="'.$LANG['FIRST_REC'].'">';
		$navStr .= '|&lt;';
		if($occIndex > 0) $navStr .= '</a>';
		$navStr .= '&nbsp;&nbsp;&nbsp;&nbsp;';
		if($occIndex > 0) $navStr .= '<a href="#" onclick="return submitQueryForm(\'back\');" title="'.$LANG['PREV_REC'].'">';
		$navStr .= '&lt;&lt;';
		if($occIndex > 0) $navStr .= '</a>';
		$recIndex = ($occIndex<$qryCnt?($occIndex + 1):'*');
		$navStr .= '&nbsp;&nbsp;| '.$recIndex.' of '.$qryCnt.' |&nbsp;&nbsp;';
		if($occIndex<$qryCnt-1) $navStr .= '<a href="#" onclick="return submitQueryForm(\'forward\');"  title="'.$LANG['NEXT_REC'].'">';
		$navStr .= '&gt;&gt;';
		if($occIndex<$qryCnt-1) $navStr .= '</a>';
		$navStr .= '&nbsp;&nbsp;&nbsp;&nbsp;';
		if($occIndex<$qryCnt-1) $navStr .= '<a href="#" onclick="return submitQueryForm('.($qryCnt-1).');" title="'.$LANG['LAST_REC'].'">';
		$navStr .= '&gt;|';
		if($occIndex<$qryCnt-1) $navStr .= '</a> ';
		if(!$crowdSourceMode){
			$navStr .= '&nbsp;&nbsp;&nbsp;&nbsp;';
			$navStr .= '<a href="occureditor.php?gotomode=1&collid=' . $collId . '" onclick="return verifyLeaveForm()" title="' . $LANG['NEW_REC'] . '">&gt;*</a>';
		}
		$navStr .= '</b>';
	}
	...
	header('Location: '.$CLIENT_ROOT.'/profile/index.php?refurl=../collections/editor/dev/occureditor.php?'.htmlspecialchars($_SERVER['QUERY_STRING'], ENT_QUOTES));
}
?>
<html>
<head>
	...
	?>
	<script src="<?= $CLIENT_ROOT ?>/js/jquery.js?ver=140310" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/jquery-ui.js?ver=140310" type="text/javascript"></script>
	...
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.coordinateValidation.js?ver=2" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/wktpolygontools.js?ver=2" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.georef.js?ver=2" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.editor.main.js?ver=5" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.editor.tools.js?ver=4" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.editor.autocomplete.js?ver=1" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/symb/collections.editor.imgtools.js?ver=3" type="text/javascript"></script>
	<script src="<?= $CLIENT_ROOT ?>/js/jquery.imagetool-1.7.js?ver=140310" type="text/javascript"></script>
	<script src="js/collections.editor.query.js?ver=6" type="text/javascript"></script>
	<style type="text/css">
	...
	<div id="innertext">
		<div id="titleDiv">
			...
			if($isEditor && $isEditor != 3){
				...
				<div id="querySymbolDiv" style="margin:5px 5px 5px 5px;">
					<a href="#" title="<?= $LANG['SEARCH_FILTER'] ?>" onclick="toggleQueryForm();"><img src="<?= $CLIENT_ROOT ?>/images/find.png" style="width:18px;" /></a>
				</div>
				<?php
			}
			?>
		...
		if($isEditor && ($occid || ($collId && $isEditor < 3))){
			...
			<div id="navDiv">
				...
				if(isset($collections_editor_occurrenceeditorCrumbs)){
					if($collections_editor_occurrenceeditorCrumbs){
						?>
						<div class="navpath">
							<a href='<?= $CLIENT_ROOT ?>/index.php'><?php echo $LANG['Home']; ?></a> &gt;&gt;
							<?php
					...
					?>
					<div class='navpath'>
						<a href="<?= $CLIENT_ROOT ?>/index.php" onclick="return verifyLeaveForm()"><?= $LANG['HOME'] ?></a> &gt;&gt;
						<?php
						if($crowdSourceMode){
							?>
							<a href="<?= $CLIENT_ROOT ?>/collections/specprocessor/crowdsource/index.php"><?= $LANG['CENTRAL_CROWD'] ?></a> &gt;&gt;
							<?php
						}
						else{
							if($isGenObs){
								?>
								<a href="<?= $CLIENT_ROOT ?>/profile/viewprofile.php?tabindex=1" onclick="return verifyLeaveForm()"><?= $LANG['PERS_MANAGEMENT'] ?></a> &gt;&gt;
								<?php
							}
							else{
								if($isEditor == 1 || $isEditor == 2){
									?>
									<a href="<?= $CLIENT_ROOT ?>/collections/misc/collprofiles.php?collid=<?= $collId ?>&emode=1" onclick="return verifyLeaveForm()"><?= $LANG['COL_MANAGEMENT'] ?></a> &gt;&gt;
									<?php
								}
							}
						}
						if($occid) echo '<a href="'.$CLIENT_ROOT.'/collections/individual/index.php?occid=' . $occManager->getOccId() . '">' . $LANG['PUBLIC_DISPLAY'] . '</a> &gt;&gt;';
						?>
				...
				if($occid && $isLocked){
					...
					<div style="margin:25px;border:2px double;padding:20px;width:90%;">
						...
						<div style="margin:20px;font-weight:bold;">
							<a href="<?= $CLIENT_ROOT ?>/collections/individual/index.php?occid=<?= $occManager->getOccId(); ?>" target="_blank"><?= $LANG['READ_ONLY'] ?></a>
						</div>
					</div>
					<?php
				}
							...
							<div id="occedittabs" style="clear:both;">
								...
								<div id="occdiv">
									<form id="fullform" name="fullform" action="occureditor.php" method="post" onsubmit="return verifyFullForm(this);">
										<?php
										/*
										$builder = new OccurrenceEditorBuilder();
										$builder->echoFieldMap();
										if($occid){
											if($fragArr || $specImgArr) $builder->setDisplayImageControls(true);
											if($crowdSourceMode) $builder->setDisplayCrowdsourceControl(true);
										}
										*/
										?>
										<fieldset>
											...
											<div style="clear:both;">
												<div id="catalogNumberDiv">
													...
													<a href="#" onclick="return dwcDoc('catalogNumber')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
													...
													<div id="identifierDiv" class="divTable">
														<div class="divTableHeading">
															<div class="divTableRow">
																<div class="divTableHead"><?php echo $LANG['IDENT_NAME']; ?> <a href="#" onclick="return dwcDoc('otherCatalogNumbers')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a></div>
														...
														<div id="identifierBody" class="divTableBody">
															...
															if(isset($occArr['identifiers'])){
																foreach($occArr['identifiers'] as $idKey => $idArr){
																	...
																	<div id="idRow-<?php echo $idKey; ?>" class="divTableRow">
																		...
																		<div class="divTableCell">
																			<input class="idValueInput" name="idvalue[]" type="text" value="<?php echo $idArr['value']; ?>" onchange="fieldChanged('idvalue');" autocomplete="off" /><a href="#" onclick="deleteIdentifier(<?php echo "'".$idKey."',".$occid; ?>);return false" tabindex="-1"><img src="<?= $CLIENT_ROOT ?>/images/del.png" /></a>
																		</div>
																	</div>
																	<?php
																}
															...
															<div class="divTableRow">
																...
																<div class="divTableCell">
																	<input class="idValueInput" name="idvalue[]" type="text" value="" onchange="fieldChanged('idvalue');" autocomplete="off" /><a href="#" onclick="addIdentifierField(this);return false" tabindex="-1"><img src="<?= $CLIENT_ROOT ?>/images/plus.png" /></a>
																</div>
															</div>
														</div>
													</div>
											...
											<div style="clear:both;">
												<div id="recordedByDiv">
													...
													<a href="#" onclick="return dwcDoc('recordedBy')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="recordNumberDiv">
													...
													<a href="#" onclick="return dwcDoc('recordNumber')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="eventDateDiv" title="Earliest Date Collected">
													...
													<a href="#" onclick="return dwcDoc('eventDate')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
											...
											<div style="clear:both;">
												<div id="associatedCollectorsDiv">
													<div class="flabel">
														...
														<a href="#" onclick="return dwcDoc('associatedCollectors')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													</div>
												...
												<div id="verbatimEventDateDiv">
													<div class="flabel">
														...
														<a href="#" onclick="return dwcDoc('verbatimEventDate')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													</div>
												...
												<div id="dateToggleDiv">
													<a href="#" onclick="toggle('dateextradiv');return false;" tabindex="-1"><img class="editimg" src="<?= $CLIENT_ROOT ?>/images/editplus.png" /></a>
												</div>
												<?php
												if($loanArr = $occManager->getLoanData()){
													...
													<fieldset style="float:right;margin:3px;padding:5px;border:1px solid red;">
														...
														<b><?php echo (isset($LANG['TO'])?$LANG['TO']:'To'); ?>:</b> <a href="<?= $CLIENT_ROOT ?>/collections/loans/outgoing.php?tabindex=1&collid=<?php echo $occManager->getCollId() . '&loanid=' . $loanArr['id']; ?>"><?= $loanArr['code']; ?></a><br/>
											...
											<div id="dateextradiv">
												<div id="ymdDiv">
													...
													<a href="#" onclick="return dwcDoc('year')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div id="dayOfYearDiv">
													...
													<a href="#" onclick="return dwcDoc('startDayOfYear')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
										...
										<fieldset>
											...
											<div style="clear:both;">
												<div id="scinameDiv">
													...
													<a href="#" onclick="return dwcDoc('scientificName')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="scientificNameAuthorshipDiv">
													...
													<a href="#" onclick="return dwcDoc('scientificNameAuthorship')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
											...
											<div style="clear:both;padding:3px 0px 0px 10px;">
												...
												if(!$occid){
													...
													echo ' <a href="#" onclick="return dwcDoc(\'idConfidence\')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a> ';
												...
												<div id="identificationQualifierDiv">
													...
													<a href="#" onclick="return dwcDoc('identificationQualifier')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div  id="familyDiv">
													...
													<a href="#" onclick="return dwcDoc('family')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
											...
											<div style="clear:both;padding:3px 0px 0px 10px;">
												<div id="identifiedByDiv">
													...
													<a href="#" onclick="return dwcDoc('identifiedBy')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div id="dateIdentifiedDiv">
													...
													<a href="#" onclick="return dwcDoc('dateIdentified')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div id="idrefToggleDiv" onclick="toggle('idrefdiv');">
													<img class="editimg" src="<?= $CLIENT_ROOT ?>/images/editplus.png" />
												</div>
											</div>
											<div  id="idrefdiv">
												<div id="identificationReferencesDiv">
													<?php echo $LANG['ID_REFERENCE']; ?>:
													<a href="#" onclick="return dwcDoc('identificationReferences')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div id="identificationRemarksDiv">
													...
													<a href="#" onclick="return dwcDoc('identificationRemarks')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												...
												<div id="taxonRemarksDiv">
													...
													<a href="#" onclick="return dwcDoc('taxonRemarks')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
										...
										<fieldset>
											...
											<div style="clear:both;">
												<div id="countryDiv">
													...
													<a href="#" onclick="return dwcDoc('country')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="stateProvinceDiv">
													...
													<a href="#" onclick="return dwcDoc('stateProvince')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="countyDiv">
													...
													<a href="#" onclick="return dwcDoc('county')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="municipalityDiv">
													...
													<a href="#" onclick="return dwcDoc('municipality')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="locationIdDiv">
													...
													<a href="#" onclick="return dwcDoc('locationID')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
											...
											<div id="localityDiv">
												...
												<a href="#" onclick="return dwcDoc('locality')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" style="width:9px" /></a>
												<br />
											...
											<div id="localityExtraDiv" style="display:<?php echo $localityExtraDiv; ?>">
												<div id="locationRemarksDiv">
													...
													<a href="#" onclick="return dwcDoc('locationRemarks')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
											...
											<div id="localSecurityDiv">
												<div style="float:left;">
													...
													<a href="#" onclick="return dwcDoc('localitySecurity')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												</div>
											...
											<div style="clear:both;">
												...
												<div id="coordinateUncertaintyInMetersDiv">
													...
													<a href="#" onclick="return dwcDoc('coordinateUncertaintyInMeters')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="googleDiv" onclick="openMappingAid();" title="<?php echo (isset($LANG['GOOGLE_MAPS'])?$LANG['GOOGLE_MAPS']:'Google Maps'); ?>">
													<img src="<?= $CLIENT_ROOT ?>/images/world.png" />
												</div>
												<div id="geoLocateDiv" title="<?php echo (isset($LANG['GEOLOCATE_LOC'])?$LANG['GEOLOCATE_LOC']:'GeoLocate Locality'); ?>">
													<a href="#" onclick="geoLocateLocality();" tabindex="-1"><img src="<?= $CLIENT_ROOT ?>/images/geolocate.png"/></a>
												</div>
												...
												<div id="geodeticDatumDiv">
													<?php echo $LANG['DATUM']; ?>
													<a href="#" onclick="return dwcDoc('geodeticDatum')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="verbatimCoordinatesDiv">
													...
													<div style="float:left;">
														...
														<a href="#" onclick="return dwcDoc('verbatimCoordinates')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
											...
											<div style="clear:both;">
												<div id="elevationDiv">
													...
													<a href="#" onclick="return dwcDoc('minimumElevationInMeters')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="verbatimElevationDiv">
													...
													<div style="float:left;">
														...
														<a href="#" onclick="return dwcDoc('verbatimElevation')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
												...
												<div id="depthDiv">
													...
													<a href="#" onclick="return dwcDoc('minimumDepthInMeters')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
													<br/>
												...
												<div id="verbatimDepthDiv">
													<div style="float:left;">
														...
														<a href="#" onclick="return dwcDoc('verbatimDepth')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
												...
												<div id="georefExtraToggleDiv" onclick="toggle('georefExtraDiv');">
													<img class="editimg" src="<?= $CLIENT_ROOT ?>/images/editplus.png" tabindex="-1" />
												</div>
											</div>
											<?php
											...
											<div id="georefExtraDiv" style="<?php echo $georefExtraDiv; ?>;">
												<div style="clear:both;">
													...
													<div id="georeferenceSourcesDiv">
														...
														<a href="#" onclick="return dwcDoc('georeferenceSources')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
												...
												<div style="clear:both;">
													<div id="georeferenceProtocolDiv">
														...
														<a href="#" onclick="return dwcDoc('georeferenceProtocol')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
													...
													<div id="georeferenceVerificationStatusDiv">
														...
														<a href="#" onclick="return dwcDoc('georeferenceVerificationStatus')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
														<br/>
										...
										<fieldset>
											...
											<div id="habitatDiv">
												...
												<a href="#" onclick="return dwcDoc('habitat')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												<br/>
											...
											<div id="substrateDiv">
												...
												<a href="#" onclick="return dwcDoc('substrate')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												<br/>
											...
											<div id="associatedTaxaDiv">
												...
												<a href="#" onclick="return dwcDoc('associatedTaxa')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												<br/>
												...
												if(!isset($ACTIVATEASSOCTAXAAID) || $ACTIVATEASSOCTAXAAID){
													echo '<a href="#" onclick="openAssocSppAid();return false;"><img class="editimg" src="'.$CLIENT_ROOT.'/images/list.png" /></a>';
												}
												?>
											</div>
											<div id="verbatimAttributesDiv">
												<?php echo $LANG['VERBATIM_ATTRIBUTES']; ?>
												<a href="#" onclick="return dwcDoc('verbatimAttributes')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												<br/>
											...
											<div id="occurrenceRemarksDiv">
												...
												<a href="#" onclick="return dwcDoc('occurrenceRemarks')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a>
												<br/>
											...
											<div id="dynamicPropertiesDiv" style="display:<?php echo array_key_exists('dynamicproperties',$occArr)&&$occArr['dynamicproperties']?'':'none'; ?>">
												...
												<a href="#" onclick="return dwcDoc('dynamicProperties')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
											...
											<div style="padding:2px;">
												<div id="lifeStageDiv">
													...
													<a href="#" onclick="return dwcDoc('lifeStage')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="sexDiv">
													<?php echo $LANG['SEX']; ?>
													<a href="#" onclick="return dwcDoc('sex')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="individualCountDiv">
													...
													<a href="#" onclick="return dwcDoc('individualCount')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="samplingProtocolDiv">
													...
													<a href="#" onclick="return dwcDoc('samplingProtocol')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="preparationsDiv">
													...
													<a href="#" onclick="return dwcDoc('preparations')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="reproductiveConditionDiv">
													...
													<a href="#" onclick="return dwcDoc('reproductiveCondition')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
													<?php
												...
												<div id="establishmentMeansDiv">
													...
													<a href="#" onclick="return dwcDoc('establishmentMeans')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
										...
										<fieldset>
											...
											<div style="padding:3px;clear:both;">
												<div id="typeStatusDiv">
													...
													<a href="#" onclick="return dwcDoc('typeStatus')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="dispositionDiv">
													...
													<a href="#" onclick="return dwcDoc('disposition')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="occurrenceIdDiv" title="If different than institution code">
													...
													<a href="#" onclick="return dwcDoc('occurrenceid')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="fieldNumberDiv" title="An identifier given to the collecting event in the field">
													...
													<a href="#" onclick="return dwcDoc('fieldnumber')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="basisOfRecordDiv">
													...
													<a href="#" onclick="return dwcDoc('basisOfRecord')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
													<?php
											...
											<div style="padding:3px;clear:both;">
												<div id="institutionCodeDiv" title="<?php echo $LANG['INST_CODE_EXPLAIN']; ?>">
													...
													<a href="#" onclick="return dwcDoc('institutionCode')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="collectionCodeDiv" title="<?php echo $LANG['COLL_CODE_EXPLAIN']; ?>">
													...
													<a href="#" onclick="return dwcDoc('collectionCode')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
												...
												<div id="ownerInstitutionCodeDiv" title="<?php echo $LANG['OWNER_CODE_EXPLAIN']; ?>">
													...
													<a href="#" onclick="return dwcDoc('ownerInstitutionCode')" tabindex="-1"><img class="docimg" src="<?= $CLIENT_ROOT ?>/images/qmark.png" /></a><br/>
			...
			elseif(!$isEditor){
				...
				if($crowdSourceMode){
					echo $LANG['ERROR_NO_CROWDSOURCING'].'<div style="margin:15px"><a href="' . $CLIENT_ROOT . '/collection/specprocessor/crowdsource/index.php">'.$LANG['RETURN_TO_CROWDSOURCING'].'</a></div>';
				}
