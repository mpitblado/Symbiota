...
<div id="admindiv">
	...
	if($collAdminList){
		...
		<fieldset style="padding:15px;margin:10px 0px;">
			...
			<form name="transrecform" method="post" target="occureditor.php">
				<div>
	...
	<fieldset style="padding:15px;margin:10px 0px;">
		...
		<form name="deleteform" method="post" action="occureditor.php" onsubmit="return confirm('<?php echo $LANG['SURE_DEL']; ?>')">
