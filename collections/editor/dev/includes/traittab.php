				...
				<fieldset style="margin-top:20px">
					...
					<div style="float:right">
						<div style="margin:0px 3px;float:right" title="<?php echo $LANG['HARD_REFRESH'];?>">
							<form name="refreshform" method="post" action="occureditor.php" >
					...
					<form name="submitform<?php echo '-'.$traitID; ?>" method="post" action="occureditor.php" onsubmit="return false">
