				...
				<div id="labeldiv-<?php echo $imgCnt; ?>" style="display:<?php echo ($imgCnt==1?'block':'none'); ?>;">
					...
					<div style="width:100%;clear:both;">
						...
						<div id="tfadddiv-<?php echo $imgCnt; ?>" style="display:none;">
							<form id="ocraddform-<?php echo $imgCnt; ?>" name="ocraddform-<?php echo $imgId; ?>" method="post" action="occureditor.php">
								<div>
							...
							if(array_key_exists($imgId,$fragArr)){
								...
								foreach($fArr as $prlid => $rArr){
									...
									<div id="tfdiv-<?php echo $imgCnt.'-'.$fragCnt; ?>" style="display:<?php echo $displayBlock; ?>;">
										<form id="tfeditform-<?php echo $prlid; ?>" name="tfeditform-<?php echo $prlid; ?>" method="post" action="occureditor.php">
											<div>
										...
										<div style="clear:both;">
											<form name="tfdelform-<?php echo $prlid; ?>" method="post" action="occureditor.php" style="margin-left:10px;width:100px;" >
