...
<div id="imagediv" style="width:795px;">
	...
	<div id="addimgdiv" style="display:<?php echo ($specImgArr?'none':''); ?>;">
		<form name="imgnewform" action="occureditor.php" method="post" enctype="multipart/form-data" onsubmit="return verifyImgAddForm(this);">
					...
					<tr>
						<td colspan="2">
							<div id="img<?php echo $imgId; ?>editdiv" style="display:none;clear:both;">
								<form name="img<?php echo $imgId; ?>editform" action="occureditor.php" method="post" onsubmit="return verifyImgEditForm(this);">
									<fieldset style="padding:15px">
								...
								<form name="img<?php echo $imgId; ?>delform" action="occureditor.php" method="post" onsubmit="return verifyImgDelForm(this);">
									<fieldset style="padding:15px">
								...
								if($displayRemapForm = $occManager->isRemappable($imgArr)){
									?>
									<form name="img<?php echo $imgId; ?>remapform" action="occureditor.php" method="post" onsubmit="return verifyImgRemapForm(this);">
										<fieldset style="padding:15px">
								...
								?>
								<form action="occureditor.php" method="post">
									<fieldset style="padding:15px">
