						...
						<form id="colleditform" name="colleditform" action="collmetadata.php" method="post" enctype="multipart/form-data" onsubmit="return verifyCollEditForm(this)">
							...
							if ($IS_ADMIN) {
								...
								<div class="field-block" style="clear:both">
									<span class="field-elem">
										<label for="sortSeq"> <?php echo (isset($LANG['SORT_SEQUENCE']) ? htmlspecialchars($LANG['SORT_SEQUENCE'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) : 'Sort Sequence'); ?>: </label>
										<span class="skip-link">
											<?php
							...
							<div class="field-block">
								<span class="field-elem">
									<label for="collectionID"> <?php echo (isset($LANG['COLLECTION_ID']) ? htmlspecialchars($LANG['COLLECTION_ID'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) : 'Collection ID (GUID)'); ?>: </label>
									<span class="skip-link">
											<?php
